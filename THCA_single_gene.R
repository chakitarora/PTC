...
beta_file='/Users/macbook/Desktop/THCA/THCA-final.csv'
...
gg
ggsave('/Users/macbook/Desktop/THCA/validation_plots/'+gene+'.jpg', plot = print(gg),height = 5 ,width = 7, dpi = 1000)
